...
#line 9 "/sessions/great-funny-faraday/goroot/src/os/user/getgrouplist_unix.go"
...
void
_cgo_9bef24737d87_Cfunc_mygetgrouplist(void *v)
{
	struct {
		char const* p0;
		gid_t p1;
	...
	_cgo_tsan_acquire();
	_cgo_r = mygetgrouplist(_cgo_a->p0, _cgo_a->p1, _cgo_a->p2, _cgo_a->p3);
	_cgo_tsan_release();
