...
#line 13 "/sessions/great-funny-faraday/goroot/src/os/user/cgo_lookup_cgo.go"
...
void
_cgo_9bef24737d87_Cfunc_mygetgrgid_r(void *v)
{
	struct {
		int p0;
		char __pad4[4];
	...
	_cgo_tsan_acquire();
	_cgo_r = mygetgrgid_r(_cgo_a->p0, _cgo_a->p1, _cgo_a->p2, _cgo_a->p3, _cgo_a->p4);
	_cgo_tsan_release();
...
CGO_NO_SANITIZE_THREAD
void
_cgo_9bef24737d87_Cfunc_mygetgrnam_r(void *v)
{
	struct {
		char const* p0;
		char* p1;
	...
	__typeof__(_cgo_a->r) _cgo_r;
	_cgo_tsan_acquire();
	_cgo_r = mygetgrnam_r(_cgo_a->p0, _cgo_a->p1, _cgo_a->p2, _cgo_a->p3, _cgo_a->p4);
	_cgo_tsan_release();
	_cgo_a = (void*)((char*)_cgo_a + (_cgo_topofstack() - _cgo_stktop));
	_cgo_a->r = _cgo_r;
	_cgo_msan_write(&_cgo_a->r, sizeof(_cgo_a->r));
...
CGO_NO_SANITIZE_THREAD
void
_cgo_9bef24737d87_Cfunc_mygetpwnam_r(void *v)
{
	struct {
		char const* p0;
		char* p1;
	...
	__typeof__(_cgo_a->r) _cgo_r;
	_cgo_tsan_acquire();
	_cgo_r = mygetpwnam_r(_cgo_a->p0, _cgo_a->p1, _cgo_a->p2, _cgo_a->p3, _cgo_a->p4);
	_cgo_tsan_release();
	_cgo_a = (void*)((char*)_cgo_a + (_cgo_topofstack() - _cgo_stktop));
	_cgo_a->r = _cgo_r;
	_cgo_msan_write(&_cgo_a->r, sizeof(_cgo_a->r));
...
CGO_NO_SANITIZE_THREAD
void
_cgo_9bef24737d87_Cfunc_mygetpwuid_r(void *v)
{
	struct {
		int p0;
		char __pad4[4];
	...
	__typeof__(_cgo_a->r) _cgo_r;
	_cgo_tsan_acquire();
	_cgo_r = mygetpwuid_r(_cgo_a->p0, _cgo_a->p1, _cgo_a->p2, _cgo_a->p3, _cgo_a->p4);
	_cgo_tsan_release();
	_cgo_a = (void*)((char*)_cgo_a + (_cgo_topofstack() - _cgo_stktop));
	_cgo_a->r = _cgo_r;
	_cgo_msan_write(&_cgo_a->r, sizeof(_cgo_a->r));
...
CGO_NO_SANITIZE_THREAD
void
_cgo_9bef24737d87_Cfunc_sysconf(void *v)
{
	struct {
		int p0;
		char __pad4[4];
