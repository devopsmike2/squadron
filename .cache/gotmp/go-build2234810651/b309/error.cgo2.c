...
#line 8 "/sessions/great-funny-faraday/go/pkg/mod/github.com/mattn/go-sqlite3@v1.14.24/error.go"
...
void
_cgo_6c9441af552b_Cfunc_sqlite3_errstr(void *v)
{
	struct {
		int p0;
		char __pad4[4];
	...
	_cgo_tsan_acquire();
	_cgo_r = (__typeof__(_cgo_a->r)) sqlite3_errstr(_cgo_a->p0);
	_cgo_tsan_release();
