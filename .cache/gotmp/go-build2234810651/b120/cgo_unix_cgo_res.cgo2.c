...
#line 11 "/sessions/great-funny-faraday/goroot/src/net/cgo_unix_cgo_res.go"
...
void
_cgo_77133bf98b3a_Cfunc_res_search(void *v)
{
	struct {
		char const* p0;
		int p1;
	...
	_cgo_tsan_acquire();
	_cgo_r = res_search(_cgo_a->p0, _cgo_a->p1, _cgo_a->p2, _cgo_a->p3, _cgo_a->p4);
	_cgo_tsan_release();
