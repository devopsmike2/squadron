...
#line 9 "/sessions/great-funny-faraday/goroot/src/net/cgo_resnew.go"
...
int
_cgo_77133bf98b3a_C2func_getnameinfo(void *v)
{
	int _cgo_errno;
	struct {
	...
	_cgo_tsan_acquire();
	errno = 0;
	_cgo_r = getnameinfo(_cgo_a->p0, _cgo_a->p1, _cgo_a->p2, _cgo_a->p3, _cgo_a->p4, _cgo_a->p5, _cgo_a->p6);
	_cgo_errno = errno;
	_cgo_tsan_release();
...
CGO_NO_SANITIZE_THREAD
void
_cgo_77133bf98b3a_Cfunc_getnameinfo(void *v)
{
	struct {
		struct sockaddr const* p0;
		socklen_t p1;
