...
#line 8 "/sessions/great-funny-faraday/go/pkg/mod/github.com/mattn/go-sqlite3@v1.14.24/sqlite3_context.go"
...
void
_cgo_6c9441af552b_Cfunc_my_result_blob(void *v)
{
	struct {
		sqlite3_context* p0;
		void* p1;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_my_result_text(void *v)
{
	struct {
		sqlite3_context* p0;
		char* p1;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_result_error_toobig(void *v)
{
	struct {
		sqlite3_context* p0;
	} __attribute__((__packed__)) *_cgo_a = v;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_result_int(void *v)
{
	struct {
		sqlite3_context* p0;
		int p1;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_result_zeroblob(void *v)
{
	struct {
		sqlite3_context* p0;
		int p1;
