...
#line 13 "/sessions/great-funny-faraday/go/pkg/mod/github.com/mattn/go-sqlite3@v1.14.24/callback.go"
...
void
_cgo_6c9441af552b_Cfunc__sqlite3_result_blob(void *v)
{
	struct {
		sqlite3_context* p0;
		const void* p1;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc__sqlite3_result_text(void *v)
{
	struct {
		sqlite3_context* p0;
		char const* p1;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_result_double(void *v)
{
	struct {
		sqlite3_context* p0;
		double p1;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_result_error(void *v)
{
	struct {
		sqlite3_context* p0;
		char const* p1;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_result_int64(void *v)
{
	struct {
		sqlite3_context* p0;
		sqlite3_int64 p1;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_result_null(void *v)
{
	struct {
		sqlite3_context* p0;
	} __attribute__((__packed__)) *_cgo_a = v;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_user_data(void *v)
{
	struct {
		sqlite3_context* p0;
		void* r;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_value_blob(void *v)
{
	struct {
		sqlite3_value* p0;
		const void* r;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_value_bytes(void *v)
{
	struct {
		sqlite3_value* p0;
		int r;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_value_double(void *v)
{
	struct {
		sqlite3_value* p0;
		double r;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_value_int64(void *v)
{
	struct {
		sqlite3_value* p0;
		sqlite3_int64 r;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_value_text(void *v)
{
	struct {
		sqlite3_value* p0;
...
CGO_NO_SANITIZE_THREAD
void
_cgo_6c9441af552b_Cfunc_sqlite3_value_type(void *v)
{
	struct {
		sqlite3_value* p0;
		int r;
