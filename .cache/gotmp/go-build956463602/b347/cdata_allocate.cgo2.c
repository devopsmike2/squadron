...
#line 21 "/sessions/great-funny-faraday/go/pkg/mod/github.com/apache/arrow-go/v18@v18.0.0/arrow/cdata/cdata_allocate.go"
 #include <stdlib.h>
...
void
_cgo_95ddaae2a49e_Cfunc_calloc(void *v)
{
	struct {
		size_t p0;
		size_t p1;
