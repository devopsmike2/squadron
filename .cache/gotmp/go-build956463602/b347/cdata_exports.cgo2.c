...
#line 19 "/sessions/great-funny-faraday/go/pkg/mod/github.com/apache/arrow-go/v18@v18.0.0/arrow/cdata/cdata_exports.go"
 #include <errno.h>
 #include <stdint.h>
 #include <stdlib.h>
...
void
_cgo_95ddaae2a49e_Cfunc_ArrowArrayMarkReleased(void *v)
{
	struct {
		struct ArrowArray* p0;
	} __attribute__((__packed__)) *_cgo_a = v;
	_cgo_tsan_acquire();
	ArrowArrayMarkReleased(_cgo_a->p0);
	_cgo_tsan_release();
}
