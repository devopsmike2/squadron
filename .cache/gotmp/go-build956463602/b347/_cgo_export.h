...
/* package github.com/apache/arrow-go/v18/arrow/cdata */
...
extern void releaseExportedArray(struct ArrowArray* arr);
extern int streamGetSchema(struct ArrowArrayStream* handle, struct ArrowSchema* out);
extern int streamGetNext(struct ArrowArrayStream* handle, struct ArrowArray* out);
extern cchar_t* streamGetError(struct ArrowArrayStream* handle);
extern void streamRelease(struct ArrowArrayStream* handle);
