...
#line 27 "/sessions/great-funny-faraday/go/pkg/mod/github.com/apache/arrow-go/v18@v18.0.0/arrow/cdata/exports.go"
 #include <stdlib.h>
...
void
_cgo_95ddaae2a49e_Cfunc_ArrowSchemaIsReleased(void *v)
{
	struct {
		struct ArrowSchema const* p0;
		int r;
		char __pad12[4];
	...
	_cgo_tsan_acquire();
	_cgo_r = ArrowSchemaIsReleased(_cgo_a->p0);
	_cgo_tsan_release();
...
CGO_NO_SANITIZE_THREAD
void
_cgo_95ddaae2a49e_Cfunc_ArrowSchemaMarkReleased(void *v)
{
	struct {
		struct ArrowSchema* p0;
	} __attribute__((__packed__)) *_cgo_a = v;
	_cgo_tsan_acquire();
	ArrowSchemaMarkReleased(_cgo_a->p0);
	_cgo_tsan_release();
}
