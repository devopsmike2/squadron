...
//line /sessions/great-funny-faraday/go/pkg/mod/github.com/marcboeker/go-duckdb@v1.8.3/errors.go:1:1
package duckdb
...
func duckdbError(err * /*line :17:23*/_Ctype_char /*line :17:29*/) error {
	return fmt.Errorf("%s: %w", duckdbErrMsg, errors.New(( /*line :18:55*/_Cfunc_GoString /*line :18:64*/)(err)))
}
