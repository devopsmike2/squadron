...
var KindDispositions = map[string]string{
	...
	"cloudtasks-retry-policy-enable":          DispositionPatchExisting,
	"cloudtasks-logging-enable":               DispositionPatchExisting,
	"pubsublite-logging-enable":               DispositionNewFile,
	"pubsublite-reservation-attach":           DispositionPatchExisting,
	"eventgrid-diagnostics-enable":            DispositionNewFile,
	"eventgrid-cloudevent-schema-enforce":     DispositionPatchExisting,
	"eventhubs-diagnostics-enable":            DispositionNewFile,
	"eventhubs-capture-enable":                DispositionPatchExisting,
