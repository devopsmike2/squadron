...
// SquadronQLHandlers handles Squadron QL query endpoints
type SquadronQLHandlers struct {
	telemetryService services.TelemetryQueryService
	executor         *query.Executor
	logger           *zap.Logger
}

// NewSquadronQLHandlers creates a new Squadron QL handlers instance
func NewSquadronQLHandlers(telemetryService services.TelemetryQueryService, logger *zap.Logger) *SquadronQLHandlers {
	return &SquadronQLHandlers{
...
// SquadronQLRequest represents a Squadron QL query request
type SquadronQLRequest struct {
...
// SquadronQLResponse represents a Squadron QL query response
type SquadronQLResponse struct {
...
// HandleSquadronQLQuery handles POST /api/v1/telemetry/query
func (h *SquadronQLHandlers) HandleSquadronQLQuery(c *gin.Context) {
	var req SquadronQLRequest
	...
	if err != nil {
		h.logger.Error("Failed to execute Squadron QL query",
			zap.Error(err),
...
func (h *SquadronQLHandlers) HandleValidateQuery(c *gin.Context) {
...
func (h *SquadronQLHandlers) HandleGetSuggestions(c *gin.Context) {
...
func (h *SquadronQLHandlers) HandleGetTemplates(c *gin.Context) {
...
func (h *SquadronQLHandlers) HandleGetFunctions(c *gin.Context) {
