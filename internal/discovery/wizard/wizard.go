	...
	return ConnectorWizard{
		...
		Steps: []WizardStep{
			...
			},
			{
				...
				Description: "Squadron will run sts:AssumeRole and tiny EC2 + Lambda + RDS + S3 + ALB + EKS + DynamoDB + ECS probes to confirm the role works. No records are created until you click Save on the next step.",
				Action: WizardAction{
