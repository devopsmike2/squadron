...
// ec2Instance / lambdaFunction directly without importing the SDK
// types separately. The aliases are package-private so external code
// keeps using the SDK's canonical names.
