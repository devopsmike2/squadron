...
// credential substrate, mirroring the proven application-store
...
// cloud_connections owner-tenant column). In the OSS build this is INERT:
...
// real per-tenant isolation of the sealed cloud IAM credentials.
...
// DefaultTenant.
var ErrTenantContextRequired = errors.New("credstore: tenant-scoped operation on an unstamped context (strict tenant scoping enabled)")
