...
[private vulnerability reporting](https://github.com/devopsmike2/squadron/security/advisories/new)
or by opening a confidential report through the channels listed in
[SECURITY.md](SECURITY.md). All complaints will be reviewed and investigated
promptly and fairly.

<!-- Maintainers: if you prefer a dedicated email contact for Code of Conduct
     reports, replace the line above with that address. -->
