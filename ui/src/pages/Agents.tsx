...
export default function AgentsPage() {
  ...
  const getDriftBadge = (status?: Agent["drift_status"]) => {
    switch (status) {
      case "synced":
        return (
          <Badge className="bg-emerald-500/10 text-emerald-700 border-emerald-500/20 dark:bg-emerald-500/20 dark:text-emerald-300">
            Synced
          </Badge>
        );
      case "drifted":
        return (
          <Badge className="bg-red-500/10 text-red-600 border-red-500/20 dark:bg-red-500/20 dark:text-red-300">
            Drifted
          </Badge>
        );
      case "no_intent":
    ...
    <>
      <PageTable
        ...
        columns={[
          ...
          { header: "Config", key: "drift_status" },
        ...
        renderRow={(agent: Agent) => (
          <>
            ...
            <TableCell>{getDriftBadge(agent.drift_status)}</TableCell>
